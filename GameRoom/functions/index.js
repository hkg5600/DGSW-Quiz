...
var config = {
  apiKey: "AIzaSyAEmgH7r79F7Z6GPtIPdQBg-o1VLnhDO0I",
  authDomain: "dgsw-quiz.firebaseapp.com",
  databaseURL: "https://dgsw-quiz.firebaseio.com//",
  storageBucket: "gs://dgsw-quiz.appspot.com",
};
      ...
      if (snapshot.val() !== null) {
        ...
        return userQuery.then((userResult) => {
          ...
          if (language_id === language_id1) {
            firebase
              .database()
              .ref(`game_room/${childKey}/${user_id}`)
              .update({
                status: true,
                right: 0,
                wrong: 0,
